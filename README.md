...
- **Offline SAP knowledge**, bundled and searchable without a live connection: ~3900 transactions plus function modules, tables and classes, plus MCP prompts that teach an agent SAP GUI conventions.
