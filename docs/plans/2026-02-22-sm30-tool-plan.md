...
| File                                  | Change                                               |
| ------------------------------------- | ---------------------------------------------------- |
| `src/sapwebguimcp/models/__init__.py` | Add SM30 model imports and **all** entries           |
| `src/sapwebguimcp/tools/__init__.py`  | Add register_sm30_tools import and **all** entry     |
